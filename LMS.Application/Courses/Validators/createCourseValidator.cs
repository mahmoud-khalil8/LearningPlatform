...
namespace LMS.Application.Courses.Validators
{
    public class createCourseValidator:AbstractValidator<CreateCoursesDto>
    {
        ...
        public createCourseValidator()
        {
            ...
            //RuleFor(course => course.Category).Custom((value, context) =>
            //{
            //    var isValidCategory = categories.Contains(value);
            //    if (!isValidCategory)
            //    {
            //        context.AddFailure("Category", "this Category is not valid");
            //    }
            //});
            RuleFor(course => course.Category).Must(categories.Contains);
        }
